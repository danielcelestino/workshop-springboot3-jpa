...
import com.aulajpamaven.course.entities.OrderItem;
...
import com.aulajpamaven.course.entities.enums.OrderStatus;
...
public class TestConfig implements CommandLineRunner{ //executa automaticamente quando o programa for iniciado
	...
	@Autowired
	private OrderRepository orderRepository; //inicializa automaticamente
	@Autowired
	private CategoryRepository categoryRepository; //inicializa automaticamente
	@Autowired
...
//	private PaymentRepository paymentRepository;
	...
	public void run(String... args) throws Exception {
		...
		Payment py1 = new Payment(null,Instant.parse("2019-06-30T20:53:07Z"),o1);
		o1.setPayment(py1);
